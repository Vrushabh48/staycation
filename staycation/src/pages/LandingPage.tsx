      ...
      <div className="relative w-full">
        ...
        <div className="bg-[#331906] text-white py-16 text-center relative">
          <div className="relative flex flex-col items-center">
            ...
            {/* Text */}
            <h1 className="mt-10 text-4xl font-cinzel font-normal px-4 py-2 leading-10 drop-shadow-lg tracking-wider w-[358px] h-[152px] md:w-[500px] md:h-[142px]">
        ...
        <div className="bg-[#331906] text-white py-16 px-10 pr-24">
          <h1 className="text-5xl font-cinzel font-normal text-center md:text-left ml-12">
            Curated by our Experts
          </h1>
          <div className="grid grid-cols-2 md:flex md:justify-start gap-8 mt-16 ml-12">
        ...
        <div className="bg-[#331906] text-white py-16 px-10">
          ...
          <div className="grid grid-cols-2 md:flex md:justify-start gap-20 mt-16 ml-12">
        ...
        <div className="bg-[#331906] text-white py-16 px-10">
          <h1 className="text-5xl font-normal font-cinzel w-[349px] text-white md:ml-20 ml-24">
            Why Us?
          </h1>
        ...
        <div id="faq-section" className="bg-[#331906] text-white py-16 px-10">
          <h1 className="text-5xl font-normal font-cinzel w-[349px] text-white md:ml-20 ml-36">
            FAQS
          </h1>
          <FAQ />
